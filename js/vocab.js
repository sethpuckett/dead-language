export default {
  words: [
    { id: 0, language1: 'weather', language2: 'tiempo' },
    { id: 1, language1: 'thing', language2: 'cosa' },
    { id: 2, language1: 'man', language2: 'hombre' },
    { id: 3, language1: 'part', language2: 'parte' },
    { id: 4, language1: 'life', language2: 'vida' },
    { id: 5, language1: 'moment', language2: 'momento' },
    { id: 6, language1: 'form', language2: 'forma' },
    { id: 7, language1: 'house', language2: 'casa' },
    { id: 8, language1: 'world', language2: 'mundo' },
    { id: 9, language1: 'woman', language2: 'mujer' },
    { id: 10, language1: 'case', language2: 'caso' },
    { id: 11, language1: 'place', language2: 'lugar' },
    { id: 12, language1: 'person', language2: 'persona' },
    { id: 13, language1: 'hour', language2: 'hora' },
    { id: 14, language1: 'work', language2: 'trabajo' },
    { id: 15, language1: 'point', language2: 'punto' },
    { id: 16, language1: 'hand', language2: 'mano' },
    { id: 17, language1: 'end', language2: 'fin' },
    { id: 18, language1: 'type', language2: 'tipo' },
    { id: 19, language1: 'people', language2: 'gente' },
    { id: 20, language1: 'example', language2: 'ejemplo' },
    ...
    { id: 28, language1: 'change', language2: 'cambio' },
