export default {
  name: 'Demo 01',
  words: [
    { id: 0, language1: 'man', language2: 'hombre', partOfSpeech: 'noun', gender: 'm', alternatives: ['señor', 'senor'] },
    { id: 1, language1: 'table', language2: 'mesa', partOfSpeech: 'noun', gender: 'f', alternatives: ['tabla'] },
    { id: 2, language1: 'life', language2: 'vida', partOfSpeech: 'noun', gender: 'f' },
    { id: 3, language1: 'mother', language2: 'madre', partOfSpeech: 'noun', gender: 'f' },
    { id: 4, language1: 'house', language2: 'casa', partOfSpeech: 'noun', gender: 'f' },
    { id: 5, language1: 'world', language2: 'mundo', partOfSpeech: 'noun', gender: 'm' },
    { id: 6, language1: 'woman', language2: 'mujer', partOfSpeech: 'noun', gender: 'f', alternatives: ['señora', 'senora'] },
    { id: 7, language1: 'place', language2: 'lugar', partOfSpeech: 'noun', gender: 'm', alternatives: ['sitio'] },
    { id: 8, language1: 'person', language2: 'persona', partOfSpeech: 'noun', gender: 'f' },
    { id: 9, language1: 'hour', language2: 'hora', partOfSpeech: 'noun', gender: 'f' },
    { id: 10, language1: 'work', language2: 'trabajo', partOfSpeech: 'noun', gender: 'm', alternatives: ['obra'] },
    { id: 11, language1: 'end', language2: 'fin', partOfSpeech: 'noun', gender: 'm', alternatives: ['final', 'extremo'] },
    { id: 12, language1: 'father', language2: 'padre', partOfSpeech: 'noun', gender: 'm' },
    { id: 13, language1: 'water', language2: 'agua', partOfSpeech: 'noun', gender: 'f' },
    { id: 14, language1: 'city', language2: 'ciudad', partOfSpeech: 'noun', gender: 'f' },
    { id: 15, language1: 'family', language2: 'familia', partOfSpeech: 'noun', gender: 'f' },
    { id: 16, language1: 'book', language2: 'libro', partOfSpeech: 'noun', gender: 'm' },
    { id: 17, language1: 'thing', language2: 'cosa', partOfSpeech: 'noun', gender: 'f', alternatives: ['chisme', 'aparato', 'vaina', 'asunto'] },
    { id: 18, language1: 'money', language2: 'dinero', partOfSpeech: 'noun', gender: 'm', alternatives: ['plata'] },
    { id: 19, language1: 'door', language2: 'puerta', partOfSpeech: 'noun', gender: 'f' },
